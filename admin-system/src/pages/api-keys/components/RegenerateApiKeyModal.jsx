      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <p className="text-sm text-gray-500 mb-4">
            Are you sure you want to regenerate the API key "{apiKey?.name}" for
            client "{apiKey?.Client?.name}"? This will create a new key and
            ...
            <div className="flex">
              <div className="flex-shrink-0">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 00-1-1z"
                    clipRule="evenodd"
                  />
                </svg>
              </div>
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>
                      The client's applications using the old key will stop
                      working
                    </li>
                    <li>
                      The client will see the new key in their updated table
                      after regeneration
                    </li>
                    <li>The client should be notified about this change</li>
                  </ul>
                </div>
              </div>
            </div>
